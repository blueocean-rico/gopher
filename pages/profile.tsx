...
import { Group, Title, Image, ScrollArea, Button, Divider, Grid, Card, Text, Badge} from "@mantine/core";
    ...
    <div>
      ...
      <div style={{ width: 340, margin: 50}}>
        <Card shadow="sm" p="lg" radius="lg">
          <Card.Section>
            <Image src="https://seattlemag.com/sites/default/files/field/image/iStock-471370245.jpg" height={160} alt="Seattle" />
          </Card.Section>
